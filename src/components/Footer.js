    ...
    return (
        <footer className="footer">
            <div className="footer_container">
                ...
                <div><a href="https://github.com/BenHbrt/weather" target="_blank" rel="noreferrer">Code</a></div>
                <div><Link to={'./credits'}>Credits</Link></div>
            </div>
            <div className="footer_container">
                <div className="footer_container_title">About Me</div>
                <a href="https://github.com/BenHbrt" target="_blank" rel="noreferrer">
                    <img className="footer_container_icon" src={require('../img/icons/github-mark-white.png')} alt="github logo" height="20px"/>
                </a>
                <a href="https://www.linkedin.com/in/benherbertcz/" target="_blank" rel="noreferrer">
